...
def parse_args():
    ...
    parser.add_argument("--task", type=str, default='grounding', choices=['all', 'grounding', 'captioning', 'v10_grounding'])
            ...
            for sentence_id, (timestamps, sentence) in enumerate(zip(data['timestamps'], data['sentences'])):
                ...
                for query_id, query in enumerate(questions['grounding']):
                    ...
                    if args.segment_head is not None:
                        ...
                        merge_u = segment_iou(merge_answer, gt, merge_result=False)
                    ...
                    if args.segment_head is None:
                        u = segment_iou(answer, gt, merge_result=False)
